...
# 我是薛閔容 Min-Jung Hsueh 👋

**國立中正大學 資訊管理學系醫療資訊管理碩士班**
...
我畢業於**國立暨南國際大學資訊管理學系**，目前就讀**國立中正大學資訊管理學系醫療資訊管理碩士班**。平常喜歡自己動手把一個想法從零蓋成一個真的能跑的系統——從畫 UML、設計資料庫，到寫後端邏輯。這份好奇心也讓我在課堂之外一頭栽進 **Kubernetes、虛擬化底層原理**，想知道那些平常用得理所當然的雲端服務，到底是怎麼被組出來的。

我也喜歡把技術用在好玩的地方，像是把「運動」設計成遊戲機制，讓深蹲、開合跳變成闖關動力。這個資料夾收錄的是我這幾年做過、覺得值得分享的專案與學習紀錄，有興趣可以透過下方的聯絡方式找我 🙌
